...
(function ($) {
    ...
    $(function () {
        ...
        var slackChatOptions = {
            ...
            queryInterval: 3000,
            slackColor: "#36a64f",
            chatBoxHeader: "Hey! Chat live with us now!",
            messageFetchCount: 10,
            botUser: 'Mineapple Player',        //username to post to #Slack. Required.
            sendOnEnter: true,
            disableIfAway: true,
            elementToDisable: slackTrigger,
            heightOffset: 75,
            useUserDetails: true
        };
    
        slackTrigger.slackChat(slackChatOptions);
